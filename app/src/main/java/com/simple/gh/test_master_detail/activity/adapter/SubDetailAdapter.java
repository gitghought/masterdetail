...
public class SubDetailAdapter extends ArrayAdapter{
    private Context context;
    private int resource;
    private ArrayList<Country> provs;

    public SubDetailAdapter(Context context, int resource, ArrayList<Country> objects) {
